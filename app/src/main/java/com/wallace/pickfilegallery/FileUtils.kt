...
//    val HIDDEN_PREFIX = "."
//
//    fun urlToPdf(context: Context, urlPdf: String) {
...
//        return true// LocalStorageProvider.AUTHORITY.equals(uri.authority)
//    }
//
//    /**
//     * @param uri The Uri to check.
...
//            return if (FileUtils.isGooglePhotosUri(uri))
//                uri.lastPathSegment
//            else
//                FileUtils.getDataColumn(
//                context,
//                uri,
//                null,
//                null
...
//        getUri(file)?.let {
//            return getThumbnail(context, it, getMimeType(file) ?: "")
//        } ?: run {
//            return null
//        }
//    }
...
//        if (BuildConfig.DEBUG) Log.d(FileUtils.TAG, "Attempting to get thumbnail")
//        if (!isMediaUri(uri)) {
//            Log.e(FileUtils.TAG, "You can only retrieve thumbnails for images and videos.")
//            return null
//        }
//        var bm: Bitmap? = null
...
//                if (BuildConfig.DEBUG) Log.d(FileUtils.TAG, "Got thumb ID: $id")
...
//            }
//        } catch (e: Exception) {
//            if (BuildConfig.DEBUG) Log.e(FileUtils.TAG, "getThumbnail", e)
//        } finally {
//            cursor?.close()
//        }
//        return bm
...
//        file.isFile && !fileName.startsWith(FileUtils.HIDDEN_PREFIX)
//    }
//
//    /**
...
//        file.isDirectory && !fileName.startsWith(FileUtils.HIDDEN_PREFIX)
//    }
//
//    /**
